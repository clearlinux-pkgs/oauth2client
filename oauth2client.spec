...
Version  : 3.0.0
Release  : 8
URL      : http://pypi.debian.net/oauth2client/oauth2client-3.0.0.tar.gz
Source0  : http://pypi.debian.net/oauth2client/oauth2client-3.0.0.tar.gz
